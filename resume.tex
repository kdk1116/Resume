...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     \textbf{Languages}{: C\#, C, C++, Python, SQL (Postgres, SQLServer, MariaDB, Oracle), Lua, JavaScript/Typescript, HTML, CSS, LaTeX, MATLAB, Powershell, Bash, Zsh} \\
     \textbf{Frameworks}{: .NET Core, ASP.NET, .NET Framework, XUnit, React, Node.js, Django, Flask, Bootstrap, Tailwind} \\
