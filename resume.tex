...
\begin{center}
    ...
    \href{https://linkedin.com/in/...}{\underline{linkedin.com/in/kevin-d-kim-684282160}} $|$
    \href{https://github.com/...}{\underline{github.com/kdk1116}}
\end{center}
...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Reduced TD cost by 15\% implementing higher order grid terms to prevent waer of wafer tables in ASML scanner using WCF services house in custom .NET framework app }
...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     \textbf{Languages}{: C\#, C++, Python, SQL (Postgres, SSMS, MariaDB, Oracle), JavaScript/Typescript, HTML/CSS, MATLAB, Powershell, Bash, Zsh} \\
