...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     \textbf{Languages}{: C\#, C++, Python, SQL (Postgres, SQLServer, MariaDB, Oracle), Lua, JavaScript/Typescript, HTML/CSS, MATLAB, Powershell, Bash, Zsh} \\
     \textbf{Frameworks}{: .NET Core, .NET Famework, XUnit, React, Node.js, Django, Flask} \\
